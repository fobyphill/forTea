        ...
        function cd(stage, delta){
            ...
            if (partners.length === 1){
                if (partners[0].id in update_stages_tp)
                    ...
                    let partner = $('#i_stage_' + partners[0].id)
                    let partner_val = (partner.val()) ? parseFloat(partner.val()) : 0
                    if (delta > 0 && delta > partner_val){
                        delta -= partner_val
                        partner_val = 0
                    }
                    else {
                    ...
                    update_stages_tp[partners[0].id].value = partner_val
                }
                if (delta){
